...
export default async function handler(
  ...
  if (req.method === "POST") {
    ...
    let mailOptions = {
      ...
      to: userEmail,
      subject: `Confirmation de rendez-vous médical : le ${new Date(startDate).toLocaleString(
        "fr-FR"
      )}`,
        ...
        <body>
          <div class="email-container">
            ...
            <div class="email-body">
              <p>Bonjour,</p>
              <p>Votre rendez-vous médical du ${new Date(startDate).toLocaleString("fr-FR")} est confirmé avec le Dr. ${docName}. Voici les détails de votre rendez-vous :</p>
